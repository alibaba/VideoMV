...
class Options:
    ...
    # fovy of the dataset
    fovy: float = 39.6 # 39.6 # 49.1
    # camera near plane
    znear: float = 0.5 # 0.1 # 0.5 
    # camera far plane
    zfar: float = 2.5 # 1000 # 2.5 
    ...
    # resume
    resume: Optional[str] = "/mnt/cap/muyuan/code/StableVideoDiffusion/StableVideoDiffusion/i2vgen-xl/LGM/pretrained/model_fp16.safetensors"
    # batch size (per-GPU)
    batch_size: int = 8
